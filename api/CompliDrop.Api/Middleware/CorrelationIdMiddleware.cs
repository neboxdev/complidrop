...
public class CorrelationIdMiddleware(RequestDelegate next)
{
    ...
    /// id is an opaque identifier rather than user content. Under the old visible-ASCII rule a
    /// client could send <c>X-Trace-Id: pat@gardenhall.com</c> and land an email address in Sentry
    /// un-redacted, breaking ADR 0037's invariant at its source. Restricting the charset makes an
    /// email- or free-text-shaped id structurally impossible to inject, while still honoring every
